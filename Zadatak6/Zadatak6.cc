...
<<<<<<< HEAD
return rand() % 100; // Možete prilagoditi raspon prema vašim potrebama
}

// Funkcija za izračun aritmetičke sume
...
srand(time(NULL) + world_rank); // Inicijalizacija generatora nasumičnih brojeva
